...
function PaletteItem({
  ...
  return (
    <div
      draggable
      // The docstring rides the app's ONE tooltip, floated beside the row so it
      // reads next to the list instead of covering the rows below.
      data-tip={def.doc?.summary}
      data-tip-side="right"
      onDragStart={(e) => {
